...
export default class SeasonsComponent extends EffortlessBaseComponent<{}, {people : any[]}> {
    ...
    async loadData() {
      ...
      payload.AirtableWhere = "Roles='Season'"
        ...
        <IonPage>
          ...
          <IonContent fullscreen>
            <IonHeader collapse="condense">
              <IonToolbar>
                <IonTitle size="large">Seasons</IonTitle>
              </IonToolbar>
            </IonHeader>
            <div>
